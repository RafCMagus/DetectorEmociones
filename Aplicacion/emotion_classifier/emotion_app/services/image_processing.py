...
# Cargar los pesos de los modelos base **una sola vez al inicio**
model_paths = [
...
def has_processed_images():
    """Verifica si hay al menos una imagen en la carpeta 'output/'."""
    output_folder = "D:/ModeloIA/Aplicacion/emotion_classifier/output/"
    if not os.path.exists(output_folder):
        return False  # Si la carpeta no existe, no hay imágenes
    return any(file.endswith(('.png', '.jpg', '.jpeg')) for file in os.listdir(output_folder))
